...
export const reconciliationApi = {
  fetchReconciliation: async (params?: ReconciliationParams): Promise<{
    ...
    const res = await axiosInstance.get<ApiResponse<{ records: ReconciliationRecord[]; summary: ReconciliationSummary }>>(
