            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {TEAM_ROLES.map((role) => (
                  <label
                    key={role}
                    className={`flex items-center justify-center py-2 px-3 rounded-lg border text-[11px] font-medium cursor-pointer transition-colors ${formData.taskName === role
                ...
                {AMOUNT_PRESETS.map((v) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-2.5 py-1 rounded-lg text-[11px] font-medium border transition-colors cursor-pointer ${active
