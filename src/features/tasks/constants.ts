...
export const TASK_STATUS_CONFIG: Record<TaskStatus, { label: string; color: string; bg: string; icon: typeof Clock }> = {
  ...
  In_Progress: { label: 'Đang vẽ', color: 'text-info', bg: 'bg-info/10', icon: ClipboardList },
  Submitted: { label: 'Chờ duyệt', color: 'text-warning', bg: 'bg-warning/10', icon: Eye },
...
export const TASK_STATUS_FILTER_OPTIONS = [
  ...
  { value: 'Submitted', label: TASK_STATUS_CONFIG.Submitted.label },
...
export const OPEN_TASK_STATUSES: TaskStatus[] = ['Pending', 'In_Progress', 'Submitted', 'Revision', 'Disputed'];

/** Task Mangaka có thể duyệt / xem kết quả */
export const REVIEWABLE_TASK_STATUSES: TaskStatus[] = ['Submitted', 'Revision', 'Approved', 'Disputed'];

export const ASSISTANT_MY_TASK_FILTER_OPTIONS: { value: string; label: string }[] = [
  { value: '', label: 'Tất cả' },
  { value: 'active', label: 'Việc cần xử lý' },
  { value: 'In_Progress', label: TASK_STATUS_CONFIG.In_Progress.label },
  { value: 'Submitted', label: TASK_STATUS_CONFIG.Submitted.label },
  { value: 'Revision', label: TASK_STATUS_CONFIG.Revision.label },
  { value: 'Approved', label: TASK_STATUS_CONFIG.Approved.label },
