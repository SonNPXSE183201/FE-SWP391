...
export const TaskQueuePage = () => (
  <div>
    <div className="page-header">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="page-header__subtitle">Danh sách công việc có thể nhận</p>
        </div>
      </div>
    </div>
    {/* TODO: Available tasks list, accept flow, filters */}
    <div className="mt-6 bg-bg-secondary border border-border-custom rounded-xl p-8 flex flex-col items-center justify-center gap-4 min-h-[300px]">
      ...
      <p className="text-text-secondary text-sm">Danh sách task khả dụng sẽ hiển thị ở đây</p>
    </div>
  </div>
);
