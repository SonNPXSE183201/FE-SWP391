...
const TX_TYPE_CONFIG: Record<TransactionType, { label: string; color: string; bg: string; icon: typeof Wallet; sign: '+' | '-' | '' }> = {
  ...
  Lock: { label: 'Lock', color: 'text-warning', bg: 'bg-warning/10', icon: Lock, sign: '-' },
  Unlock: { label: 'Unlock', color: 'text-info', bg: 'bg-info/10', icon: Unlock, sign: '+' },
